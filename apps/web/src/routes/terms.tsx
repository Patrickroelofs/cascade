	...
	return (
		<>
			...
			<main className="prose mx-auto max-w-3xl p-8 min-h-128">
				...
				<h2>Your content</h2>
				<p>
					You retain ownership of the content you create in Cascade. You
					grant us a license to host and process that content solely to
				...
				<p>
					...
					disrupt it, access it using unauthorized means, or use it for
					unlawful purposes.
				</p>

				<h2>Termination</h2>
				<p>
					You may stop using Cascade and delete your account at any time. We
				...
				<p>
					...
					Cascade after changes take effect constitutes acceptance of the
					updated Terms.
				</p>
