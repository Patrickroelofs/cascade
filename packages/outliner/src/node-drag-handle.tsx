	...
	function NodeDragHandle(_props, ref) {
		...
		return (
			<button
				...
				className="shrink-0 cursor-grab touch-none text-dark-grey dark:text-ginger opacity-0 group-hover/node:opacity-100 group-focus-within/node:opacity-100 pointer-coarse:opacity-100"
			>
