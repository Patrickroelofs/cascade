...
## 2026-07-18
- Pasting or typing a raw URL into node content now auto-converts it into a link, showing a tidy label (e.g. the hostname) while the full URL stays available on hover; links are always underlined with an external-link icon. [#183](https://github.com/Patrickroelofs/cascade/issues/183)
