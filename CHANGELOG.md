...
## 2026-07-22
- [feat] Added a "Tree history" button above the outline, gated behind the same premium seat as per-node version history: it lists every content edit across your entire tree in one place, newest first, each linking back to its node so you can restore it without opening every node individually. [#408](https://github.com/Patrickroelofs/cascade/issues/408)
