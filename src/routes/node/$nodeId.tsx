...
export const Route = createFileRoute("/node/$nodeId")({
	loader: async ({ context, params }) => {
		await context.queryClient.ensureQueryData(orpc.getNode.queryOptions({ input: { id: params.nodeId } }));
	},
...
function NoteZoomPage() {
	...
	const { data } = useSuspenseQuery(orpc.getNode.queryOptions({ input: { id: nodeId } }));
